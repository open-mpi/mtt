...
from db_pgv3 import DatabaseV3
    ...
    def POST(self, **kwargs):
        ...
        #
            ...
            if 'filters' in data['query'].keys():
                filters = [f['filter_left'] + " " + f['filter_mid'] + " " + f['filter_right'] for f in data['query']['filters']]
            else:
                filters = []
            ...
            query_data = self._db._query(table_name, filters=filters, row_id=row_id, fields=fields)
